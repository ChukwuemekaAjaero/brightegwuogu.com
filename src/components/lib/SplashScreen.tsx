...
export default function SplashScreen({ progress, isVisible }: SplashScreenProps) {
    return (
        <div className="flex flex-col items-center gap-8">
            {/* Logo or Title */}
            <h1 className={`text-center text-4xl font-bold text-white md:text-5xl lg:text-6xl ${antonFont.className} uppercase`}>Bright Egwuogu</h1>

            {/* Loading Bar */}
            <div className="w-64 overflow-hidden bg-gray-800 md:w-80">

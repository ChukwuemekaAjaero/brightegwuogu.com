    ...
    return (
        <div className="relative scroll-smooth">
            <div className="relative z-10">
                ...
                <section className="wmin-h-screen relative z-10 overflow-hidden pt-16">
                    <div className="py-20">
                        {/* SEARCH COMPONENT */}
                        <div className="mx-auto mb-12 max-w-4xl px-4 sm:px-8">
                            <div className="mb-8 text-center">
                                <motion.h2
                                    ...
                                    className={`mb-4 text-4xl font-bold text-white sm:text-5xl md:text-7xl xl:text-8xl ${antonFont.className} uppercase`}
                                >
                                    Sermons
                                </motion.h2>
                                <motion.p
